  ...
  const achievements = [
    {
      ...
      img: "/gallery/Achievements/frontend-certificate.jpg",
    },
    {
      title: "🎨 UI/UX Design Training Certificate",
      img: "/gallery/Achievements/uiux-certificate.jpg",
    },
  ];
  ...
  return (
    <section className="g-projects-feed">
      <motion.h2
        ...
        className="g-title"
      >
        My <span className="grad">Certificates</span>
      </motion.h2>
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              <button className="g-close-modal" onClick={() => setOpen(false)}>✕</button>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
